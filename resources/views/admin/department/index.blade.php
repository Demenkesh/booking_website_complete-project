            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary">
                        <h4 class="text-white">Department Page
                            <a href="{{ url('create-department') }}" class="float-end btn btn-success btn-sm">
                                Add department
                            </a>
                        </h4>
                    </div>
                    <div class="card-body table-responsive">
                        ...
                        <table id="example1" class="display ">
                            ...
                            <tbody>
                                ...
                                @forelse ($department as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('edit-department/' . $item->id) }}" class="btn btn-warning"> <i
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7">No department Avaliable</td>
                                    </tr>
                                @endforelse
