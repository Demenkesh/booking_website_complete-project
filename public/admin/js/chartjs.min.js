...
!(function (t, e) {
        ...
        _update(t = Date.now()) {
            ...
            e._charts.forEach((n, o) => {
                ...
                l && (o.draw(), e._notify(o, n, t, "progress")),
                    s.length ||
                        ((n.running = !1), e._notify(o, n, t, "complete")),
                    (i += s.length);
            }),
                (e._lastDate = t),
                0 === i && (e._running = !1);
    ...
    function $t(t, e, i, n, o) {
        let s = e[o];
        return (
            s || ((s = e[o] = t.measureText(o).width), i.push(o)),
            s > n && (n = s),
            n
        );
    }
    ...
    function te(t, e, i, n, o, s = {}) {
        ...
        for (
            t.save(),
                s.translation &&
                    t.translate(s.translation[0], s.translation[1]),
        ...
        return (
            we(t, i, e, function (t, i, l) {
                ...
                const c = t.getCenterPoint(o),
                    h = s(e, c);
                h < a
                    ? ((r = [{ element: t, datasetIndex: i, index: l }]),
                      (a = h))
                    : h === a &&
                      r.push({ element: t, datasetIndex: i, index: l });
            }),
            r
        );
    }
    function Pe(t, e, i, n) {
        ...
        return (
            (function (t, e) {
                ...
                t[r](o[a], n) &&
                    s.push({ element: t, datasetIndex: e, index: i }),
    ...
    var De = {
        modes: {
            ...
            nearest: (t, e, i, n) =>
                Se(t, ve(e, t), i.axis || "xy", i.intersect, n),
    ...
    const hi = (t) => 0 === t || 1 === t,
        ...
        ui = (t, e, i) =>
            Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) + 1,
        fi = {
            linear: (t) => t,
            easeInQuad: (t) => t * t,
            easeOutQuad: (t) => -t * (t - 2),
    ...
    class Ai {
        ...
        applyStack(t, e, i) {
            const n = this.chart,
                ...
                s = e[t.axis];
            return vi(
                { keys: yi(n, !0), values: e._stacks[t.axis] },
                s,
                o.index,
                { mode: i }
            );
        ...
        draw() {
            ...
            let c;
            for (
                n.dataset && n.dataset.draw(e, s, r, l), c = r;
                c < r + l;
                ++c
            ) {
                const t = o[c];
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                g.$shared &&
                    ((g.$shared = l), (s[a] = Object.freeze(Ci(g, l)))),
                g
            );
        }
    ...
    class ji extends Oi {
        ...
        _computeLabelItems(t) {
            ...
            let p,
                ...
                D = "middle";
            if ("top" === o)
                (y = e.bottom - u), (v = e._getXAxisLabelAlignment());
            else if ("bottom" === o)
        ...
        drawGrid(t) {
            ...
            if (i.display)
                for (l = 0, c = r.length; l < c; ++l) {
                    const t = r[l];
                    i.drawOnChartArea &&
                        h({ x: t.x1, y: t.y1 }, { x: t.x2, y: t.y2 }, t),
                        i.drawTicks &&
                            h(
                                { x: t.tx1, y: t.ty1 },
                                { x: t.tx2, y: t.ty2 },
    ...
    class Mn {
        ...
        unregister(t) {
            ...
            i in e && delete e[i],
                n &&
                    i in mt[n] &&
                    (delete mt[n][i], this.override && delete ut[i]);
        }
    }
    var wn = new (class {
        constructor() {
    ...
    function zn(t, e) {
        return (
            "top" === t || "bottom" === t || (-1 === Fn.indexOf(t) && "x" === e)
        );
    }
    function Vn(t, e) {
        return function (i, n) {
    ...
    class Yn {
        ...
        _initialize() {
            ...
            return (
                ...
                t.options.responsive
                    ? t.resize()
                    : be(t, t.options.devicePixelRatio),
                t.bindEvents(),
            ...
            i &&
                ...
                J(s, (i) => {
                    const s = i.options,
                        ...
                        l = K(s.type, i.dtype);
                    (void 0 !== s.position &&
                        zn(s.position, r) === zn(i.dposition)) ||
        ...
        buildOrUpdateControllers() {
            ...
            let n, o;
            for (
                t._removeUnreferencedMetasets(), n = 0, o = i.length;
                n < o;
                n++
            ) {
                const o = i[n];
        ...
        _destroyDatasetMeta(t) {
            ...
            i &&
                i.controller &&
                (i.controller._destroy(), delete e._metasets[t]);
        }
        destroy() {
            const t = this,
                { canvas: e, ctx: i } = t;
            let n, o;
            for (
                t.stop(), a.remove(t), n = 0, o = t.data.datasets.length;
                n < o;
                ++n
            )
                t._destroyDatasetMeta(n);
    ...
    class no extends Ai {
        ...
        update(t) {
            const e = this,
                ...
                { circumference: h, rotation: d } = e._getRotationExtents(),
                {
                    ...
                    if (e < bt) {
                        const r = t,
                            ...
                            u = Math.sin(l),
                            f = (t, e, n) =>
                                Wt(t, r, l) ? 1 : Math.max(e, e * i, n, n * i),
                            g = (t, e, n) =>
                ...
                y =
                    (_ - Math.max(_ * l, 0)) /
                    e._getVisibleDatasetWeightTotal();
            (e.offsetX = g * _),
                (e.offsetY = p * _),
    ...
    class oo extends Ai {
                        ...
                        (s = u
                            ? Ht(
                                  Math.max(
                                      ...
                                      i
                                          ? 0
                                          : ie(e, l, a.getPixelForValue(h)).hi +
                                                1
                                  ),
                                  o,
                                  n
        ...
        getMaxOverflow() {
            ...
            const s = o[0].size(t.resolveDataElementOptions(0)),
                a = o[o.length - 1].size(
                    t.resolveDataElementOptions(o.length - 1)
                );
                ...
                (t.fillStyle = i.backgroundColor),
                    ...
                    (function (t, e) {
                        ...
                        isNaN(e.circumference) ||
                            (e.endAngle =
                                e.startAngle + (e.circumference % bt)),
                            uo(t, e),
                            t.fill();
                    })(t, e),
                    fo(t, e),
        ...
        for (d = 0; d <= c; ++d)
            (u = o[(r + (p ? c - d : d)) % a]),
                u.skip ||
                    ...
                    (f = u));
        return (
            l && ((u = o[(r + (p ? c : 0)) % a]), h(t, f, u, p, s.stepped)), !!l
        );
    }
    function bo(t, e, i, n) {
        const o = e.points,
    ...
    function _o(t) {
        ...
        return !(t._decimated || t._loop || e.tension || e.stepped || i)
            ? bo
            : xo;
    }
    (go.id = "arc"),
            ...
            inner: {
                ...
                radius: {
                    ...
                    bottomRight: Math.max(
                        0,
                        s.bottomRight - Math.max(o.b, o.r)
                    ),
                },
            },
        };
                ...
                for (const l of i)
                    l.col !== a &&
                        ...
                        (r = o(
                            n,
                            t.top + e + s,
                            t.bottom - t.columnSizes[a].height
                        ))),
                        (l.top = r),
                        (l.left += t.left + s),
                        (r += l.height + s);
                ...
                !(function (t, e, i) {
                    ...
                    if (
                        ...
                        a.fillRect(h.leftForLtr(t, x), i, x, b),
                            0 !== n &&
                                a.strokeRect(h.leftForLtr(t, x), i, x, b);
                    }
                    a.restore();
                })(h.x(P), D, e),
                    (P = s(k, P + x + p, t.right)),
    ...
    class ps extends Oi {
        ...
        getTitle(t, e) {
            ...
            let r = [];
            return (
                (r = ss(r, as(o))), (r = ss(r, as(s))), (r = ss(r, as(a))), r
            );
        }
        getBeforeBody(t, e) {
    ...
    function bs(t, e, i) {
        ...
        if (-1 === n)
            return ((t, e, i) =>
                "string" == typeof e ? t.push(e) - 1 : isNaN(e) ? null : i)(
                t,
                e,
                i
            );
            ...
            return (
                ...
                null === t || isNaN(t)
                    ...
                    : e.getPixelForDecimal(
                          t === e.min
                              ? 0
                              : (St(t) - e._startValue) / e._valueRange
                      )
            );
        }
        getValueForPixel(t) {
        ...
        fit() {
            ...
            e.display && e.pointLabels.display
                ? (function (t) {
                      ...
                      for (n = 0; n < l; n++) {
                          const l = t.options.pointLabels.setContext(
                              t.getContext(n)
                          );
                          (r[n] = l.padding),
    ...
    class Vs extends ji {
        ...
        buildTicks() {
            const t = this,
                ...
                o =
                    "labels" === n.source
                        ? t.getLabelTimestamps()
                        : t._generate();
            "ticks" === e.bounds &&
                o.length &&
                ((t.min = t._userMin || o[0]),
            ...
            return (
                ...
                (t._majorUnit =
                    n.major.enabled && "year" !== t._unit
                        ? (function (t) {
                              for (
                                  let e = Ls.indexOf(t) + 1, i = Ls.length;
                                  e < i;
                                  ++e
                              )
        ...
        _getLabelCapacity(t) {
            const e = this,
                ...
                r =
                    Math.floor(
                        e.isHorizontal() ? e.width / a.w : e.height / a.h
                    ) - 1;
            return r > 0 ? r : 1;
        }
        getDataTimestamps() {
